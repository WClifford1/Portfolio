            ...
            <div style={{paddingLeft: "1%", paddingRight: "1%"}}>
                ...
                <Timeline mode="alternate">
                    ...
                    <Timeline.Item onClick={() => this.opensortal()} color="green">
                        <p className="timehead" style={{color:"black", cursor:"pointer"}}><Icon type="caret-right" style={sortal? {transform:"rotate(90deg)"} : undefined} /> Started internship with Sortal Aug 2019</p>
                    ...
                    <Timeline.Item onClick={() => this.openmernApp()} dot={<Icon type="clock-circle-o" style={{ fontSize: '16px' }} />}>
                        <p className="timehead" style={{color:"black", cursor:"pointer"}}>Created Wotnot Media portfolio web app Jul 2019 <Icon type="caret-left" style={mernApp? {transform:"rotate(270deg)"} : undefined} /></p>
                    ...
                    <Timeline.Item onClick={() => this.openrailsApp()}>
                        <p className="timehead" style={{color:"black", cursor:"pointer"}}><Icon type="caret-right" style={railsApp? {transform:"rotate(90deg)"} : undefined} /> Created Ruby on Rails two-sided marketplace app May 2019</p>
                    ...
                    <Timeline.Item onClick={() => this.openrubyApp()} color="red">
                        <p className="timehead" style={{color:"black", cursor:"pointer"}}>Created first terminal app Mar 2019 <Icon type="caret-left" style={rubyApp? {transform:"rotate(270deg)"} : undefined} /></p>
                    ...
                    <Timeline.Item onClick={() => this.opencoderAc()} dot={<Icon type="clock-circle-o" style={{ fontSize: '16px' }} />}>
                        <p className="timehead" style={{color:"black", cursor:"pointer"}}><Icon type="caret-right" style={coderAc? {transform:"rotate(90deg)"} : undefined} /> Started Coderacademy Mar 2019</p>
